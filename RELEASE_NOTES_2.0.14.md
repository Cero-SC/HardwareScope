# HardwareScope 2.0.14

This forward candidate replaces the failed 2.0.13 CI attempt. It selects the
available PowerShell 7 test interpreter on hosted runners to avoid cross-edition
module-loading failures; runtime repairs are unchanged.
